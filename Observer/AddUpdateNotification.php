...
namespace ETechFlow\OrderEmailEditor\Observer;
...
{
    private const PACKAGE    = 'etechflow/module-order-email-editor';
    private const LATEST_URL = 'https://license-service.etechflow.com/composer/latest/etechflow/module-order-email-editor.json';
    private const CACHE_KEY  = 'etechflow_oee_update_check';
    private const CACHE_TTL  = 21600;
    private const MODULE_NAME = 'ETechFlow_OrderEmailEditor';
    ...
    public function execute(Observer $observer): void
    {
        try {
            ...
            $title = (string) __('eTechFlow Order Email Editor %1 is available', $latest['version']);
