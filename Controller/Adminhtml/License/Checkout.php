...
class Checkout extends Action
{
    ...
    public function execute(): ResultInterface
    {
        ...
        $gate = $this->resultFactory->create(ResultFactory::TYPE_REDIRECT)->setPath('order_email_editor/license/gate');
        ...
        $payload = json_encode([
            ...
            'magento_callback' => $this->getUrl('order_email_editor/license/activated'),
            'magento_cancel'   => $this->getUrl('order_email_editor/license/gate'),
        ]);
